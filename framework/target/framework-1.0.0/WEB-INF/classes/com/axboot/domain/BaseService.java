package com.axboot.domain;

import com.axboot.domain.code.QCommonCode;
import com.axboot.domain.file.QCommonFile;
import com.axboot.domain.program.QProgram;
import com.axboot.domain.program.menu.QMenu;
import com.axboot.domain.user.QUser;
import com.axboot.domain.user.auth.QUserAuth;
import com.axboot.domain.user.auth.menu.QAuthGroupMenu;
import com.axboot.domain.user.role.QUserRole;
